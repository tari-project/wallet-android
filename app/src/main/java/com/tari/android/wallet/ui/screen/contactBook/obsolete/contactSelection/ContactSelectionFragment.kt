...
open class ContactSelectionFragment : CommonXmlFragment<FragmentContactsSelectionBinding, ContactSelectionViewModel>(), TextWatcher {
    ...
    private fun subscribeViewModal() = with(viewModel) {
        ...
        observe(selectedContact) { contactDto ->
            putEmojiId(contactDto.walletAddress.fullEmojiId)
            ui.addFirstNameInput.setText(contactDto.alias.orEmpty().trim())
        }
...
//            ValueAnimator.setDuration = Constants.UI.shortDurationMs
