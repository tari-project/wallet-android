...
enum class ContactAction(val icon: Int, val title: Int) {
    ...
    OpenProfile(R.drawable.vector_contact_action_details, R.string.contact_book_add_title),
    ...
    Link(R.drawable.vector_contact_action_link, R.string.contact_book_add_title),
    Unlink(R.drawable.vector_contact_action_unlink, R.string.contact_book_add_title),
    Delete(R.drawable.tari_empty_drawable, R.string.contact_book_add_title),
}