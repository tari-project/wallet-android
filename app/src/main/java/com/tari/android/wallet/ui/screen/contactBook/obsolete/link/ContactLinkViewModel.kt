...
import com.tari.android.wallet.ui.screen.contactBook.obsolete.link.adapter.linkHeader.ContactLinkHeaderViewHolderItem
...
class ContactLinkViewModel(savedState: SavedStateHandle) : CommonViewModel() {
    ...
    private val ffiContact: Contact = savedState.getOrThrow(PARAMETER_CONTACT)
    ...
    val ContactLinkModel.UiState.viewItemList: List<CommonViewHolderItem>
        get() = emptyList<CommonViewHolderItem>()
//        get() {
//            if (searchViewHolderItem == null) {
//                searchViewHolderItem = ContactLinkHeaderViewHolderItem(::onSearchQueryChanged, ffiContact.walletAddress)
//            }
//
...
//        }
    ...
    private fun getBody(sourceList: List<Contact>): SpannedString {
...
//        }
        ...
        return SpannedString(HtmlHelper.getSpannedText(resourceManager.getString(R.string.contact_book_contacts_book_link_empty_state_title)))
    }
...
//    }
    ...
    private fun showLinkDialog(phoneContactDto: Contact) {
...
//        )
    ...
    private fun showLinkSuccessDialog(phoneContactDto: Contact) {
        val tariWalletAddress = ffiContact.walletAddress
        val name = ffiContact.alias.orEmpty()
