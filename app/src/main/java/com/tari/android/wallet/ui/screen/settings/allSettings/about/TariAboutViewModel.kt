...
class TariAboutViewModel : CommonViewModel() {
    ...
    private fun initList() {
        _iconList.value = mutableListOf(
            ...
            TariIconViewHolderItem(
                R.drawable.vector_all_settings_report_bug_icon,
                tari_about_icon_text_speach_bublles,
                tari_about_icon_url_speach_bublles
            ),
            TariIconViewHolderItem(
                R.drawable.vector_all_settings_contribute_to_tari_icon,
                tari_about_icon_text_keyboard,
                tari_about_icon_url_keyboard
            ),
            ...
            TariIconViewHolderItem(
                R.drawable.vector_all_settings_select_theme_icon,
                tari_about_icon_text_select_theme,
                tari_about_icon_url_select_theme
            ),
